    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(blank='', default='', max_length=50, verbose_name='姓名（实名）')),
                ('id_card', models.CharField(blank='', default='', max_length=50, verbose_name='身份证号（实名）')),
                ...
                ('avatar', models.ImageField(blank=True, default='image/default.png', null=True, upload_to='image/%Y/%m', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.CharField(choices=[('register', '注册'), ('reset_pwd', '忘记密码'), ('update_mobile', '更新手机号')], max_length=20)),
                ('send_time', models.DateTimeField(default=datetime.datetime.now)),
            ],
            options={
                'verbose_name': '手机验证码',
