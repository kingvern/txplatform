...
from .views import PolicyListView, PolicyDetailView, AddChartView, AddUserAskView, APolicyDataView, BPolicyDataView, \
    AddPolicyView, chartDataView, PolicyBannerView
